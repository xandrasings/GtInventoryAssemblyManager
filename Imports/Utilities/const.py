...
PRODUCT_COMPONENT_LIST_START_ROW = 7
PRODUCT_COMPONENT_LIST_MAX = 26
...
ROW = 'row'
COLUMN = 'column'
ROW_BORDER_OFFSET = 'row_border_offset'
COLUMN_BORDER_OFFSET = 'column_border_offset'
